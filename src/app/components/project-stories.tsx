...
const projects = [
  {
    ...
    subtitle: "Festival companion app with real-time tracking",
    ...
    idea: "Build a cross-platform event app with Mapbox 3D live location, in-app purchases, and online queue management.",
    tech: ["Flutter", "Mapbox 3D", "Realtime Location APIs", "In-App Purchases"],
    impact: "Enabled real-time friend tracking and smoother on-site service flows for festival attendees.",
  },
  {
    id: 2,
    title: "MyNanny",
    ...
    tech: ["Flutter", "LLM", "Vector Similarity", "Realtime Geolocation"],
    impact: "Reduced manual search effort by more than 60% with automated and personalized sitter matching.",
  },
  {
    id: 3,
    title: "P·CLUB",
    ...
    problem: "Users and event organizers need a seamless platform to discover events, buy tickets, and manage entry.",
    idea: "Create a ticketing product similar to Ticketmaster with digital and NFT-based ticket support.",
    tech: ["Flutter", "Stripe", "Xendit", "REST APIs", "PostgreSQL"],
    impact: "Improved end-to-end ticket purchase and management flow for concerts, dance, ballet, and live events.",
  },
  {
    id: 4,
    title: "FinanceFlow",
    ...
    problem: "Users need a simple way to track income, expenses, and month-to-month financial changes.",
    idea: "Build an app with category-based tracking, visual analytics, and financial recommendations.",
    tech: ["Flutter", "Charts", "REST APIs", "Firebase"],
    impact: "Enabled clearer spending insights with monthly comparisons, trend graphs, and savings recommendations.",
  },
];
