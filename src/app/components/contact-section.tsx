...
const contacts = [
  {
    icon: Mail,
    label: "Email",
    value: "firdaus@example.com",
    href: "mailto:firdaus@example.com",
  ...
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    value: "linkedin.com/in/firdaus",
    href: "https://linkedin.com/in/firdaus",
    description: "Connect professionally",
  },
  {
    icon: Github,
    label: "GitHub",
    value: "github.com/firdaus",
    href: "https://github.com/firdaus",
